      ...
      <Box width="85%" m="auto">
        ...
        <Flex direction="column" pb="70px">
          <HStack justifyContent="space-between" mb="15px">
            ...
            <Button bg="#3D73DA" color="white" p="5px 15px">
              Create Project
            </Button>
          </HStack>
          <HStack>
        ...
        >
          <Flex>
            <VStack mr="9%" align="flex-start" width="20%" textAlign="left">
              <Text fontSize="18px" color="#44505E" fontWeight="bold">
                Project details
              </Text>
              <Text color="grey">
                Choosing a color helps separate projects and the hours logged
                against them.
              </Text>
            </VStack>
                    ...
                    <Portal>
                      <PopoverContent width="75%">
                        ...
                        <PopoverBody>
                          ...
                          <Button mt="10px" width="100%" colorScheme="blue">
                            Create client
                          </Button>
                        </PopoverBody>
                      </PopoverContent>
        ...
        >
          <Flex>
            <VStack mr="9%" align="flex-start" width="20%" textAlign="left">
              ...
              <Text color="grey">
                Add people to allow them to log hours to this project.
              </Text>
              <Text color="grey">
                Add people to allow them to log hours to this project.
              </Text>
